...
class BasicBlock {
 public:
	...
	void add_IRInstr(IRInstr::Operation op, IRInstr::Type t, std::vector<std::string> params);
...
class CFG {
 public:
	...
	void add_to_symbol_table(std::string name, IRInstr::Type t);
	std::string create_new_tempvar(IRInstr::Type t);
	int get_var_index(std::string name);
	IRInstr::Type get_var_type(std::string name);
 ...
 protected:
	std::map <std::string, IRInstr::Type> SymbolType; /**< part of the symbol table  */
