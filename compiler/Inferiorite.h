...
/**
 * Subclass of the class Expression which represents inferiority test
 */
class Inferiorite : public Expression {

public:
    // Constructor
    Inferiorite(Expression* exprGMember, Expression* exprRMember);
    // Destructor
    ~Inferiorite();
